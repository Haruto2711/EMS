            ...
            <% List<BaseSalaryDTO> baseSalaries = (List<BaseSalaryDTO>) request.getAttribute("baseSalaries");
                ...
                List<Departments> departments = (List<Departments>) request.getAttribute("departments");
                    List<Positions> positions = (List<Positions>) request.getAttribute("positions");
                        ...
                        if (totalFilteredItems == null) totalFilteredItems = (baseSalaries != null ? baseSalaries.size()
                        : 0);
                        ...
                        <body>
                              ...
                              <div class="user-block">
                                <div class="user-avatar">
                                  <%= session.getAttribute("username") !=null ?
                                    session.getAttribute("username").toString().substring(0,1).toUpperCase() : "M" %>
                                </div>
                                <div>
                                  <div class="user-name">
                              ...
                              <div class="bs-filter-card">
                                <form action="base-salaries" method="GET" class="bs-filter-form" id="filterForm">
                                  ...
                                  <div class="bs-search-wrapper">
                                    <svg class="bs-search-icon" width="16" height="16" viewBox="0 0 24 24" fill="none"
                                  ...
                                  <select name="departmentId" class="bs-select"
                                    ...
                                    <% if (departments !=null) { for (Departments dept : departments) { boolean
                                      isSelected=selectedDeptId !=null && selectedDeptId.equals(dept.getId()); %>
                                ...
                                <table class="bs-table">
                                  ...
                                  <tbody>
                                    <% if (baseSalaries !=null && !baseSalaries.isEmpty()) { String[]
                                      ...
                                      , "#f472b6" }; for (BaseSalaryDTO item : baseSalaries) { String
                                      ...
                                      code=item.getEmployeeCode() !=null ? item.getEmployeeCode() : "" ; String
                                      dept=item.getDepartmentName() !=null ? item.getDepartmentName() : "Chưa phân công"
                                      ; String pos=item.getPositionName() !=null ? item.getPositionName()
                                      : "Chưa phân công" ; String formattedSalary=item.getFormattedBaseSalary() + " đ" ;
                                      double rawSalary=item.getBaseSalary() !=null ? item.getBaseSalary().doubleValue()
                                      : 0; int npt=item.getDependentsCount(); %>
                                      <tr>
                                      ...
                                      <% } %>
                                        ...
                                        <div class="modal-form-group">
                                          ...
                                          <div class="currency-input-wrapper">
                                            <input type="number" id="editBaseSalary" name="baseSalary" required
                                              step="100000" min="0" value="22000000" />
                                        ...
                                        <div class="modal-form-group">
                                          ...
                                          <div class="stepper-control">
                                            ...
                                            <input type="number" id="editDependentsCount" name="dependentsCount"
                                              class="stepper-input" value="2" min="0" readonly />
                                            <button type="button" class="stepper-btn" onclick="changeNPT(1)">+</button>
                                          </div>
                                        </div>
                          ...
                          <%! // Helper to construct pagination URLs cleanly private String buildPageUrl(String search,
                            Integer deptId, Integer posId, int page, int pageSize) { StringBuilder sb=new
                            StringBuilder("base-salaries?page=").append(page).append(" &pageSize=").append(pageSize);
      if (search != null && !search.trim().isEmpty()) {
          try {
              sb.append(" &search=").append(java.net.URLEncoder.encode(search, " UTF-8")); } catch (Exception ignored)
