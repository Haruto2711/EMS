                ...
                <%@ page import="java.util.List" %>
                    <%@ page import="com.ems.model.Departments" %>
                        <%@ page import="com.ems.model.Timesheetperiods" %>
                            <% List<Timesheetperiods> periods = (List<Timesheetperiods>)
                                    request.getAttribute("periods");
                                    List<Departments> departments = (List<Departments>)
                                            request.getAttribute("departments");
                                            Integer selectedPeriodId = (Integer)
                                            request.getAttribute("selectedPeriodId");
                                            Integer selectedDeptId = (Integer)
                                            request.getAttribute("selectedDepartmentId");
                                                    ...
                                                    <div class="main-content">
                                                        ...
                                                        <div class="page-body">
                                                            ...
                                                            <div class="ps-header"
                                                                ...
                                                                <!-- Nút này sau này sẽ gọi logic tính lương mới của bạn -->
                                                                <button class="btn-success-run">
                                                                ...
                                                                <table class="table-payslip">
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th style="text-align: right;">TRỪ KHẤU TRỪ
                                                                            </th>
