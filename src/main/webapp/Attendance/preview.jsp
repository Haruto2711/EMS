                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="bg-[#F3F6FD] text-slate-600 text-xs uppercase tracking-wide">
                                ...
                                <th class="px-5 py-3 text-left font-semibold">Chỉnh sửa</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-slate-100">
                            <c:forEach var="r" items="${sessionScope.previewList}">
                                <tr class="hover:bg-slate-50 transition">
                                    ...
                                    <td class="px-5 py-3">
                                            <a href="${pageContext.request.contextPath}/Attendance/edit.jsp"
                                               class="inline-flex items-center px-3 py-1.5 text-xs font-semibold text-blue-600 bg-blue-50 rounded-md hover:bg-blue-100">
                                                Edit
                                            </a>
                                        </td>
                                </tr>
