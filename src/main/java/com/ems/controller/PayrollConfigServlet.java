...
public class PayrollConfigServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            //OT
            item.setOtweekdayrate(new BigDecimal(request.getParameter("otweekdayrate")));
            item.setOtweekendrate(new BigDecimal(request.getParameter("otweekendrate")));
            item.setOtholidayrate(new BigDecimal(request.getParameter("otholidayrate")));
